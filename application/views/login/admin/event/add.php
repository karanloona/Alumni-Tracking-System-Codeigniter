	...
	$(function(){
		$('#submit').click(function(){
			...
			if(title=="" || title==0){$('.title').addClass('is-invalid title'); return false;}
				...
				$.ajax({
					url:"<?= base_url('admin/event/add_event/')?>",
					type:'post',
					dataType:'json',
					async:true,
					data:event_form,
...
<h1 class="display-4">Add New Event</h1><br>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				...
				<input type="text" class="form-control name" name="name" id="name" placeholder="Organizer Name">
		...
		<div class="col-sm-6">
			<div class="form-group">
				...
				<input type="number" class="form-control mobile" name="mobile" id="mobile" placeholder="Organizer Contact Number">
